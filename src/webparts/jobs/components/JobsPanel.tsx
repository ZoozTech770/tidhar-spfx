...
import { IJobsPanelProps } from './IJobsPanelProps';

const JobsPanel: React.FC<IJobsPanelProps> = (props) => {
  const { title, list, toAllLinkTitle, toAllLinkUrl, toAllLinkNewTab, jobPage, context } = props;
