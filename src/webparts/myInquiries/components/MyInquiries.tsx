...
import { IMyInquiriesProps } from './IMyInquiriesProps';

const MyInquiries: React.FC<IMyInquiriesProps> = (props) => {
  ...
  return (
    <MyInquiriesUI title={title} inquiries={myInquiries} newForm={newForm} allInquiries={allInquiries} showPendingApproval={showPendingApproval} allFormList={allFormList}
    />
  );
